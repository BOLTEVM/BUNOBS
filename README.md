...
* 🎛️ **Web Audio Mixing Console**: Connect and mix microphone hardware, screenshare system sound, and looping video elements. Features vertical visual LED decibel bars (green-yellow-red) calculated at 60fps via standard `AnalyserNode` frequency peak data.
* 🎭 **Double-Canvas Studio Mode**: Toggle between a single monitor and professional dual screens. Edit your layouts in **Preview** and smoothly swap them into **Program** with transition filters like **Cut**, **Fade (400ms)**, and **Slide (600ms)**.
